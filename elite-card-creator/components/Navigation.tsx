        ...
        {isOpen && (
          <div className="absolute top-full left-0 mt-2 w-56 bg-slate-900 border border-slate-700 rounded-xl shadow-2xl overflow-hidden animate-[fadeIn_0.2s_ease-out]">
            <button
              ...
              className={`w-full text-left px-4 py-3 flex items-center gap-3 hover:bg-slate-800 transition-colors ${currentView === 'FORGE' ? 'bg-slate-800 text-blue-400' : 'text-slate-300'
                }`}
            >
              <Hammer size={18} />
            ...
            <button
              ...
              className={`w-full text-left px-4 py-3 flex items-center gap-3 hover:bg-slate-800 transition-colors ${currentView === 'COLLECTOR_HOME' || currentView === 'BINDER' ? 'bg-slate-800 text-green-400' : 'text-slate-300'
                }`}
            >
              <LayoutGrid size={18} />
              <div className="flex flex-col">
            ...
            <button
              ...
              className={`w-full text-left px-4 py-3 flex items-center gap-3 hover:bg-slate-800 transition-colors ${currentView === 'SHOP' ? 'bg-slate-800 text-amber-400' : 'text-slate-300'
                }`}
            >
              <ShoppingBag size={18} />
              <div className="flex flex-col">
